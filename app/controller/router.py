...
from app.controller.email_sender.email_sender_controller import email_sender_router
...
api_router.include_router(email_sender_router, prefix="/email-sender", tags=["Email Sender"])
